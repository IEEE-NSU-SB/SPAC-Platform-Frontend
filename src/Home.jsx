    ...
    <>
      ...
      >
        ...
        <section className="w-full">
          <h3 className="text-2xl md:text-4xl font-extrabold text-ieee-darkblue pt-14 text-center">
            Last Year SPAC
          </h3>
        </section>

          <div className="md:w-5xl mx-auto aspect-video overflow-hidden max-md:mx-3 rounded-[12px] py-12">
            <video
